...
transArrInd :: Show a => ArrInd a -> Result
transArrInd x = case x of
  ArrInd _ expr -> failure x
transArrSize :: Show a => ArrSize a -> Result
transArrSize x = case x of
  ArrSize _ integer -> failure x
transStmt :: Show a => Stmt a -> Result
transStmt x = case x of
  FnDef _ type_ ident args block -> failure x
  Empty _ -> failure x
  BStmt _ block -> failure x
  Decl _ type_ item -> failure x
  ...
  ArrInit _ ident arrinds expr -> failure x
...
transType x = case x of
  ...
  Arr _ type_ arrsizes -> failure x
