...
instance Print (ArrInd a) where
  prt i e = case e of
    ArrInd _ expr -> prPrec i 0 (concatD [doc (showString "["), prt 0 expr, doc (showString "]")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print (ArrSize a) where
  prt i e = case e of
    ArrSize _ n -> prPrec i 0 (concatD [doc (showString "["), prt 0 n, doc (showString "]")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print (Stmt a) where
  prt i e = case e of
    ...
    Decl _ type_ item -> prPrec i 0 (concatD [prt 0 type_, prt 0 item, doc (showString ";")])
    ...
    ArrInit _ id arrinds expr -> prPrec i 0 (concatD [prt 0 id, prt 0 arrinds, doc (showString "="), prt 0 expr, doc (showString ";")])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
...
instance Print (Type a) where
  prt i e = case e of
    ...
    Arr _ type_ arrsizes -> prPrec i 0 (concatD [doc (showString "arr"), prt 0 type_, prt 0 arrsizes])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print (Expr a) where
  prt i e = case e of
    ...
    EArrAcc _ id arrinds -> prPrec i 7 (concatD [prt 0 id, prt 0 arrinds])
    ...
    AnF _ type_ args block -> prPrec i 5 (concatD [doc (showString "!"), prt 0 type_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
